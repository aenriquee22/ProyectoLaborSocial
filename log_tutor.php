...
<div class="container">
    <div class="logo"></div>
    <h1 class="title">Usted Iniciara Como Tutor</h1>
  </div>
  <br>
  <br>
  <br>
  <br>
        <main>
            ...
            <div class="contenedor__todo">
                ...
                <div class="contenedor__login-register">
                    <!--Login-->
                    <form action="validar_tutor_login.php" method="post" class="formulario__login">
                        <h2>Iniciar Sesión como Tutor</h2>
    ...
    <?php
        include("registro_formulario_tutor.php");
    ?>
</body>
</html>